...
{
    [Collection("api")]
    public class MovieTests : IClassFixture<CustomWebApplicationFactory>
    {
        readonly HttpClient _client;

        public MovieTests(CustomWebApplicationFactory factory)
        {
        ...
        private async Task<HttpResponseMessage> AddMovieRankData(int testUserId, string movieName = "test-MovieName")
        {
            ...
            var response = await _client.PostAsync($"movies/{testUserId}", stringContent);
